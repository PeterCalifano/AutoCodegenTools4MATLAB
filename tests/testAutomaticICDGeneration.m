...
% Apply templates
cellProcessedTabs = CAutoGenICD.ApplyTableTemplate({tableICD_state_bus, ...
                                                    tableICD_data_bus, ... 
                                                    tableICD_conf_bus} ); % Use default order of fields

tableICD_state_bus = cellProcessedTabs{1};
tableICD_data_bus  = cellProcessedTabs{2};
tableICD_conf_bus  = cellProcessedTabs{3};
